...
These functions are currently only available in the development version
of {phinterval} and are not yet stable. You can install the development
version from GitHub using `pak::pak("EthanSansom/phinterval")`.
